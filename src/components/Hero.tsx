  ...
  return (
    ...
    >
      ...
      */}
      ...
      <motion.div
        className="relative z-20 text-center px-4 sm:px-6 max-w-5xl mx-auto w-full pt-[max(3.5rem,calc(env(safe-area-inset-top,0px)+2.5rem))] pb-10 sm:pt-6 sm:pb-16"
        style={{ opacity }}
      >
